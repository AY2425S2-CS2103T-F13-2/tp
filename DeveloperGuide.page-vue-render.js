...
with(this){return _c('ul',[_c('li',[_v("Provides a customer list where they are able to track customers and their orders")]),_v(" "),_c('li',[_v("Provides a inventory list so they can keep track of incoming deliveries and current stocks")]),_v(" "),_c('li',[_v("Daily pastry list (Products list)")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Clients")]),_v(": A client in a bakery is a regular or business customer who places orders for baked goods, often in bulk or on a recurring basis.")]),_v(" "),_c('li',[_c('strong',[_v("Customers")]),_v(": A customer in a bakery is an individual who purchases baked goods for personal consumption.")]),_v(" "),_c('li',[_c('strong',[_v("Ingredients")]),_v(": Ingredients for a bakery are the raw materials, such as flour, sugar, eggs, and butter, used to create baked goods like bread, cakes, and pastries.")]),_v(" "),_c('li',[_c('strong',[_v("Inventory")]),_v(": Inventory in a bakery refers to the stock of raw ingredients, packaging materials, and finished baked goods available for production and sale.")]),_v(" "),_c('li',[_c('strong',[_v("Local storage")]),_v(": Local storage in terms of an application refers to a method of storing data on a user's device, allowing application to save information persistently without requiring a server connection.")]),_v(" "),_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, macOS")]),_v(" "),_c('li',[_c('strong',[_v("Orders")]),_v(": Orders in a bakery refer to customer requests for specific baked goods, either for immediate purchase or scheduled pickup/delivery, often including custom or bulk requests.")]),_v(" "),_c('li',[_c('strong',[_v("Pastries")]),_v(": Pastries in a bakery refer to baked goods made from dough or batter, often enriched with butter, sugar, and fillings like cream, fruit, or chocolate, including items such as croissants, danishes, and tarts.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Mon, 17 Mar 2025, 12:46:54 GMT+8]")])])])}
}];
